...
function resolveItem(parsed){
  ...
  if(!hits.length)return {status:"unknown",parsed:parsed};
  var top=hits[0];
...
export {FOODDB, findByBarcode, gramsFor, loadFoods, lookupBarcode, normBarcode, nutritionFor, offBarcode, offSearch, parseFoodInput, recalcItem, rememberBarcode, resolveItem, sumNutrition, toLogItem, UNITS};
